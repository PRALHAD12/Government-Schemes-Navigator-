...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-indigo-600 p-12 text-white relative items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-700 to-indigo-900 opacity-90"></div>
        {/* Abstract shapes */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
           <div className="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-white/10 blur-3xl mix-blend-overlay"></div>
           <div className="absolute bottom-[10%] right-[10%] w-[40%] h-[40%] rounded-full bg-indigo-400/20 blur-3xl mix-blend-overlay"></div>
        </div>
        
        <div className="relative z-10 w-full max-w-lg">
          <h1 className="text-5xl font-extrabold tracking-tight mb-6">Government Schemes<br/>Navigator</h1>
          <p className="text-xl text-indigo-100 mb-10 leading-relaxed">
            Discover, track, and apply for government schemes tailored specifically to you. Your gateway to empowerment.
          </p>
          <div className="space-y-4">
             <div className="flex items-center space-x-3 bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-indigo-50 font-medium">Personalized scheme recommendations</p>
             </div>
             <div className="flex items-center space-x-3 bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                   <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                </div>
                <p className="text-indigo-50 font-medium">Easy application tracking system</p>
             </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-16 bg-white animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <a href="#" className="font-medium text-sm text-indigo-600 hover:text-indigo-500 transition-colors">
                    Forgot password?
                  </a>
                </div>
                <div className="relative group">
